        ...
        <div className="flex flex-col gap-3 w-full max-w-[350px]">
          ...
          <div className="bg-white border border-gray-300 px-10 py-10 flex flex-col items-center shadow-sm">
            ...
            >
              ...
              <button
                type="button"
                className="flex items-center justify-center gap-2 text-[#385185] font-semibold text-sm w-full"
              >
              ...
              <Link
                href="#"
                className="mt-4 text-[#00376b] text-[12px] text-center hover:underline"
              >
                Forgot password?
              </Link>
            </form>
