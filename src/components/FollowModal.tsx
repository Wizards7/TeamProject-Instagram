  ...
  return (
    ...
    >
      <motion.div
        ...
        className="bg-white dark:bg-[#262626] rounded-xl w-full max-w-[400px] max-h-[480px] flex flex-col shadow-2xl overflow-hidden"
      ...
      >
        ...
        <div className="flex-1 overflow-y-auto custom-scrollbar min-h-[200px] flex flex-col">
          {isLoading ? (
            ...
            <div className="flex flex-col items-center justify-center py-12 text-center px-8 flex-1">
              ...
              <p className="font-bold text-black dark:text-white">
                {title.toLowerCase() === "followers" || title.toLowerCase() === "подписчики" || title.toLowerCase() === "обуначиён" 
                  ? t("noFollowers") 
                  : t("noFollowing")}
              </p>
            </div>
            ...
            <div className="py-2">
              {users.map((user) => (
                <FollowUserItem key={user.id} user={user} onClose={onClose} />
              ))}
            </div>
          )}
        </div>
